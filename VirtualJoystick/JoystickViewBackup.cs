...
{
    public class JoystickViewBackup : View
    {
        // Constants
        ...
        public JoystickViewBackup(Context context, IAttributeSet attrs) :
            base(context, attrs)
        {
            Initialize();
        }

        public JoystickViewBackup(Context context, IAttributeSet attrs, int defStyle) :
		...
		if (e.Action == MotionEventActions.Up)
            ...
            //}
            //if (onJoystickMoveListener != null && e.Action == MotionEventActions.Down)
            //{
